      ...
      >
        <div class="block w-full md:w-2/3 p-3 pt-16 md:p-0 md:pt-0 mx-auto">
          ...
          <div class="mt-1 md:mt-3 text-justify">
            An ordinary human who has spent almost all of his free time
            exploring code since a teenager, and taking advantage of freelance
            opportunities or projects in search of new challenges and learnings.
            I believe that in the world of technology, experience is everything
          ...
          <div class="grid gap-4 grid-cols-3 mt-10">
            <a
              ...
              class="
                ...
                justify-center
                md:justify-between
                hover:border-2 hover:cursor-pointer
                transform
                active:scale-90
              "
...
export default {
  components: { Projects, Blogs, Bookmarks },
  data: () => ({
    divider: 0.3,
    isMobile: false,
    showIconHighlight: false,
        ...
        list: [
          {
            name: 'Vue.js',
            show: false,
            svg: 'M2,3H5.5L12,15L18.5,3H22L12,21L2,3M6.5,3H9.5L12,7.58L14.5,3H17.5L12,13.08L6.5,3Z',
            bgColor: 'bg-vuejs',
          ...
          },
          {
            name: 'Vuetify',
            show: false,
            svg: 'M12,11.64L7.92,2H16.08L12,11.64M12,21.95L3.27,4.91H7.84L12,14.47L16.16,4.91H20.73L12,21.95Z',
            bgColor: 'bg-cyan',
            logoColor: 'text-cyan',
          },
          {
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            name: 'Git',
            show: false,
            svg: 'M2.6,10.59L8.38,4.8L10.07,6.5C9.83,7.35 10.22,8.28 11,8.73V14.27C10.4,14.61 10,15.26 10,16A2,2 0 0,0 12,18A2,2 0 0,0 14,16C14,15.26 13.6,14.61 13,14.27V9.41L15.07,11.5C15,11.65 15,11.82 15,12A2,2 0 0,0 17,14A2,2 0 0,0 19,12A2,2 0 0,0 17,10C16.82,10 16.65,10 16.5,10.07L13.93,7.5C14.19,6.57 13.71,5.55 12.78,5.16C12.35,5 11.9,4.96 11.5,5.07L9.8,3.38L10.59,2.6C11.37,1.81 12.63,1.81 13.41,2.6L21.4,10.59C22.19,11.37 22.19,12.63 21.4,13.41L13.41,21.4C12.63,22.19 11.37,22.19 10.59,21.4L2.6,13.41C1.81,12.63 1.81,11.37 2.6,10.59Z',
            bgColor: 'bg-git',
            logoColor: 'text-git',
          },
          {
            name: 'VSCode',
            show: false,
            svg: 'M17,16.47V7.39L11,11.93M2.22,9.19C1.92,8.87 1.91,8.37 2.2,8.04L3.4,6.93C3.6,6.75 4.09,6.67 4.45,6.93L7.87,9.54L15.8,2.29C16.12,1.97 16.67,1.84 17.3,2.17L21.3,4.08C21.66,4.29 22,4.62 22,5.23V18.73C22,19.13 21.71,19.56 21.4,19.73L17,21.83C16.68,21.96 16.08,21.84 15.87,21.63L7.85,14.33L4.45,16.93C4.07,17.19 3.6,17.12 3.4,16.93L2.2,15.83C1.88,15.5 1.92,14.96 2.25,14.63L5.25,11.93',
            bgColor: 'bg-vscode',
  ...
  methods: {
    ...
    showTooltip(type, name) {
      ...
      const indexType = this.techStack.findIndex((item) => {
        return item.type === type
      })
      const indexList = this.techStack[indexType].list.findIndex((item) => {
        return item.name === name
      })
      this.techStack[indexType].list[indexList].show =
        !this.techStack[indexType].list[indexList].show
    },
    highlightSocmed(i) {
      if (i === 5) {
